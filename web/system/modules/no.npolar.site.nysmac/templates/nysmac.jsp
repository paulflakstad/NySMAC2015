<%-- 
    Document   : NySMAC master template (based on MOSJ2015 master template)
    Created    : Aug 14, 2015
...
String siteName             = cms.property("sitename", "search", "Ny-Ålesund Science Managers Committee (NySMAC)");
//boolean loggedInUser        = OpenCms.getRoleManager().hasRole(cms.getCmsObject(), CmsRole.WORKPLACE_USER);
...
<link rel="apple-touch-icon" sizes="120x120" href="<%= cms.link("/apple-icon-120x120.png") %>">
<link rel="apple-touch-icon" sizes="144x144" href="<%= cms.link("/apple-icon-144x144.png") %>">
<link rel="apple-touch-icon" sizes="152x152" href="<%= cms.link("/apple-icon-152x152.png") %>">
<link rel="apple-touch-icon" sizes="180x180" href="<%= cms.link("/apple-icon-180x180.png") %>">
<link rel="icon" type="image/png" sizes="192x192"  href="<%= cms.link("/android-icon-192x192.png") %>">
<link rel="icon" type="image/png" sizes="32x32" href="<%= cms.link("/favicon-32x32.png") %>">
<link rel="icon" type="image/png" sizes="96x96" href="<%= cms.link("/favicon-96x96.png") %>">
...
<script type="text/javascript" src="<%= cms.link("/system/modules/no.npolar.site.nysmac/resources/js/modernizr.js") %>"></script>
<!--[if lt IE 9]>
...
<script type="text/javascript" src="<%= cms.link("/system/modules/no.npolar.site.nysmac/resources/js/commons.js") %>"></script>
<!--<script type="text/javascript" src="<%= cms.link("/system/modules/no.npolar.site.nysmac/resources/js/nav-off-canvas.js") %>"></script>-->
...
<link rel="stylesheet" type="text/css" href="<%= cms.link("/system/modules/no.npolar.site.nysmac/resources/style/non-responsive-dynamic.css") %>" />
<link rel="stylesheet" type="text/css" href="<%= cms.link("/system/modules/no.npolar.site.nysmac/resources/style/ie8.css") %>" />
<![endif]-->
...
<body id="<%= homePage ? "homepage" : "sitepage" %>"><div id="wrapwrap"><div id="wrap">
    <a id="skipnav" tabindex="1" href="#contentstart"><%= cms.labelUnicode("label.nysmac.global.skip-to-content") %></a>
    <div id="jsbox"></div>
    <div id ="top">
            ...
            <div id="header-mid" class="clearfix">
                <div class="fullwidth-centered">
                    ...
                    <a id="identity" href="<%= HOME_URI %>" tabindex="2">
                        <img src="<%= cms.link("/system/modules/no.npolar.site.nysmac/resources/style/logo-nysmac.jpg") %>" alt="NySMAC logo" />
                        <span id="identity-text"><%= cms.labelUnicode("label.nysmac.global.sitename") %></span>
                    </a>
                    ...
                    <div id="search-global" class="searchbox global-site-search">
                        <form method="get" action="<%= SERP_URI %>">
                            <label for="query" class="hidden"><%= cms.labelUnicode("label.nysmac.global.search") %></label>
                            <input type="search" class="query query-input" name="query" id="query" placeholder="<%= cms.labelUnicode("label.nysmac.global.search.placeholder") %>" />
                            <button class="search-button" title="<%= cms.labelUnicode("label.nysmac.global.search.submit") %>" onclick="submit()"><i class="icon-search"></i></button>
                        </form>
                    </div>
                    <!-- end new version -->
...
<script type="text/javascript">
    ...
    if (nonResIE()) {
        ...
        var warningWasDisplayedCookie = warningWasDisplayedCookieId + "; path=/; domain=nysmac.npolar.no";
        var foundCookie = 0;
